...
MemPrO is intended to be run on PDB files, and will output the following files:
  ...
  * Rank_{n}: This is a folder that contains all the relevant information for a particular rank. It contains the following files/folders:
    ...
    * mem_curve_rank{n}_{0/1}.png: This is a graphical representation of the curvature of the membrane. 0/1 indicates the outer/inner membrane (This is currently WIP).
	
    * mem_thick_rank{n}_{0/1}.png: This is a graphical representation of the thinning of the membrane. 0/1 indicates the outer/inner membrane (This is currently WIP).
